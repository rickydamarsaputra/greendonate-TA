...
export default function StoryCard({ item }) {
  return (
    <View className="w-[48.5%] h-[140px] justify-between bg-white mb-3 p-2 shadow-sm shadow-black/50 rounded-lg">
      <View>
        <Text className="text-sm text-primary-500 font-medium">{item.author}</Text>
