...
export default function termsAndConditions() {
  return (
    ...
    >
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">1. Penerimaan Donasi:</Text>
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">2. Pencarian Penerima Donasi:</Text>
      <Text className="leading-5 text-justify text-gray-500 ml-4">
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">3. Pelacakan Donasi:</Text>
      <Text className="leading-5 text-justify text-gray-500 ml-4">
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">4. Tanggung Jawab Pengguna:</Text>
      <Text className="leading-5 text-justify text-gray-500 ml-4">
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">5. Penggunaan Data Pribadi:</Text>
      <Text className="leading-5 text-justify text-gray-500 ml-4">
      ...
      <Text className="leading-5 text-justify font-semibold text-primary-600 mt-4">6. Penolakan Tanggung Jawab:</Text>
